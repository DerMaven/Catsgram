...
public class PostService {
    ...
    public Post create(Post post) {
        User postAuthor = userService.findUserByEmail(post.getAuthor().getUsername());
        if (postAuthor == null) {
    ...
    public Collection<Post> getPostsByUser(String userId) {
        User user = userService.findUserById(userId)
                .orElseThrow(() -> new UserNotFoundException("Пользователь с идентификатором: " + userId + " не был найден"));
